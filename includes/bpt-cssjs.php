...
add_action( 'admin_print_styles-store_page_wpsc-buddypressticketing', 'bpt_add_admin_css' );
...
function bpt_add_attendee_css() {
	...
	wp_enqueue_style( 'bpt-ticketing', plugins_url( '/css/attendee.css', __FILE__ ), array(), BPT_VERSION );
	wp_print_styles();
}
